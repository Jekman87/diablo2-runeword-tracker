...
export const ru: Strings = {
  ...
  footer: {
    ...
    easterEggs: [
      ...
      // «Хроника» — the in-game Chronicle log this whole tracker mirrors, not
      // the runeword Lore, whose official name «История» is unrelated.
      "Хроника: Ты не найдешь Мощь Тираэля!",
    ],
