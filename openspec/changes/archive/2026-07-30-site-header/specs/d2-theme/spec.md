...
colour for the patch line. No token SHALL be declared for them, and the token
held for a link colour of its own SHALL be removed, because the header renders the
gold family instead and nothing else renders that colour.
