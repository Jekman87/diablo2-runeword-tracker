# progress-transfer Specification

## Purpose

The contract for carrying a player's progress between browsers as a file — that
crafted runewords are written out as a plain ASCII list of canonical English
names in a stable order and nothing else, that an imported file replaces stored
