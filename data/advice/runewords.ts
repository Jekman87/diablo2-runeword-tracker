...
export const runewordAdvice: Record<string, RunewordAdviceEntry> = {
  ...
  Wealth: {
    ...
    advice: {
      ...
      ru: [
        "Специализированная броня для фарма золота и магических вещей. Собирайте её в Латах мага (Mage Plate) с 3 гнёздами — именно эту основу называют в большинстве завершённых сделок: низкое требование к силе позволяет любому фарм-персонажу надеть её без лишних статов.",
  ...
  White: {
    ...
    advice: {
      ...
      ru: [
        "Жезл только для некроманта и одно из самых дешёвых сильных кастерских оружий в игре (всего Dol Io). Руны копеечные — вся ценность в основе: Костяной жезл (Bone Wand) или Мрачный жезл (Grim Wand) с 2 гнёздами, на котором выпали стаффмоды +3 к Костяному копью или Костяному духу, ведь White добавляет свои костяные скиллы сверху.",
  ...
  Beast: {
    ...
    advice: {
      ...
      ru: [
        "Собирайте в Секире берсерка (Berserker Axe) с 5 гнёздами — в завершённых сделках эта основа с большим отрывом лидирует: быстрая скорость атаки и небольшие требования. Весь смысл — в ауре Фанатизма 9 уровня, которая разгоняет физические билды вокруг вас.",
        "Классические хозяева: некроманты и друиды-призыватели, дающие Фанатизм своей армии, милишники, стакающие ауры, и любители побегать Медведем-оборотнем через оскилл. Руны дорогие (Ber), но спрос живой, и Beast в хорошей основе продаётся стабильно.",
      ],
      sources: [
        {
          label: "Maxroll tier list",
  ...
  "Breath of the Dying": {
    ...
    advice: {
      ...
      ru: [
        "Классическое эндгеймовое оружие ближнего боя на 6 гнёзд. Руна Zod делает его неразрушимым, поэтому эфирная элитная основа — строго правильный выбор: в завершённых сделках доминирует эфирный Громовой молот (Thunder Maul), за ним Секира берсерка, Клинок колосса и Боевая пика. Эфирная Боевая пика или Молотилка на 6 гнёзд — чудовищное оружие для наёмника 2 акта.",
  ...
  "Call to Arms": {
    ...
    advice: {
      ...
      ru: [
        "Универсальная вещь для второго слота оружия: Боевой приказ и Боевую команду со свапа хочет каждый персонаж любого класса. Поскольку оно лежит только на свапе, статы основы не важны — стандарт это обычный Кристальный меч (Crystal Sword) или Цеп (Flail) с 5 гнёздами, и именно они доминируют в завершённых сделках.",
  ...
  Chaos: {
    ...
    advice: {
      ...
      ru: [
        "Коготь только для ассасина, весь смысл которого — оскилл Вихрь, основа билда Whirlwind-ассасинки. Собирайте в Рунических когтях (Runic Talons) или Сувайе (Suwayyah) с 3 гнёздами — почти все завершённые сделки называют именно эти основы; обычно в пару берут коготь Fury во вторую руку ради скорости.",
  ...
  "Chains of Honor": {
    ...
    advice: {
      ...
      ru: [
        "Главная защитная броня эндгейма: +2 ко всем навыкам и огромные +65 ко всем сопротивлениям плюс снижение урона. Собирайте в Архонтских латах (Archon Plate) с 4 гнёздами — это самая ходовая основа с большим отрывом — или в Сумеречном саване ради низкой силы; Священные латы (Sacred Armor) — если гонитесь за максимальной защитой.",
  ...
  Enigma: {
    ...
    advice: {
      ...
      ru: [
        "Самая знаменитая броня в игре: даёт Телепорт любому классу, плюс +2 к навыкам, кучу силы и мэджик-файнд. Собирайте в Латах мага (Mage Plate) с 3 гнёздами — это безоговорочно самая ходовая основа: низкое требование к силе идеально кастерам, а собственная +сила Enigma закрывает остальную экипировку; Архонтские латы или Сумеречный саван — если хочется больше защиты при тех же требованиях.",
  ...
  Exile: {
    ...
    advice: {
      ...
      ru: [
        "Паладинский щит для уберов: заряды Похищения жизни, аура Непокорности и самопочинка. Собирайте в элитном паладинском щите с 4 гнёздами и высоким базовым сопротивлением всему — в завершённых сделках лидируют Священный тарж (Sacred Targe), Щит вихря (Vortex Shield) и Священный рондаш (Sacred Rondache). Эфирная основа здесь реально желанна: самопочинка не даёт ей сломаться, а эфирный бонус вместе с Непокорностью выдаёт огромную защиту.",
        "Фирменный щит смайтеров в убер-Тристраме, где Похищение жизни держит их на ногах. Без Jah, но всё равно недёшево (Vex, Ohm); для классовой вещи торгуется бойко, и щит в хорошей основе продаётся.",
      ],
      sources: [
        {
          label: "Maxroll tier list",
  ...
  "Hand of Justice": {
    ...
    advice: {
      ...
      ru: [
        "Огненный близнец аурных оружий: Святой огонь 16 уровня плюс солидные -20% к сопротивлению врагов огню. Завершённые сделки почти единодушны в основе — Фазовый клинок (Phase Blade) с 4 гнёздами за скорость и отсутствие проблем с прочностью.",
  ...
  Infinity: {
    ...
    advice: {
      paragraphs: [
        "Make it ethereal for your act 2 mercenary — merc gear takes no durability loss, so ethereal is strictly better. It needs a 4-socket base; most completed trades name Scythe and Mancatcher (low-requirement bases popular since all polearms and spears became viable), with Threshers and Giant Threshers behind them.",
      ...
      ru: [
        "Делайте его эфирным для наёмника 2-го акта — снаряжение наёмников не теряет прочность, поэтому эфир строго лучше. Нужна база с 4 гнёздами; в большинстве завершённых сделок — коса (Scythe) и ловец (Mancatcher), базы с низкими требованиями, популярные с тех пор, как открыли все древковые и копья; следом идут Молотилки (Thresher) и Гигантские молотилки.",
